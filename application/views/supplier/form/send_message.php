                ...
                <div class="tab-content">
					<div class="tab-pane  fade in active" id="sms">
						...
						<input type="hidden" name="type" value="M">
								<?php if($form_type == "manual"): ?>
								<div class="row">
										<div class="form-group col-sm-5">
											<input type="tel" class="form-control1" name="mobile" placeholder="Type number to send message..." autocomplete="off">
										</div>
								</div>
								<?php endif; ?>
								<div class="row">
					...
					<div class="tab-pane  fade in" id="email">
						...
						<input type="hidden" name="type" value="E">
								...
								<div class="row">
										<div class="form-group col-sm-5">
											<input type="email" class="form-control1" name="email" placeholder="Type email to send email..." autocomplete="off">
										</div>
								</div>
								<?php endif; ?>
								<div class="row">
					...
					<div class="tab-pane  fade in" id="whatsapp">
						...
						<input type="hidden" name="type" value="W">
								...
								<div class="row">
										<div class="form-group col-sm-5">
											<input type="tel" class="form-control1" name="mobile" placeholder="Type number to send whatsapp..." autocomplete="off">
										</div>
								</div>
								<?php endif; ?>
								<div class="row">

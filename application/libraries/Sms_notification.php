...
public function __construct(){
    ...
    private function check_internet_connection(){
          ...
          if(!$net_conn){  
                $response['status']  = "ERR";
                $response['message'] = "Sorry, you are offline can't send sms to your mobile";
    ...
    private function active_api() {
        $this->CI->load->model('app/cuaccount_model', 'account');
    ...
    public function sendMessage($mobile) {
        ...
        // encode message
        $textmessage = urlencode($this->textmessage." Thank You,  Regards : bigmee");
